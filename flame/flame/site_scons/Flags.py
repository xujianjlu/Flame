...
CPP_BLD_ENV_IN = 'flame/building_env.h.in'
CPP_BLD_ENV_OUT = 'util/global_init/building_env.h'
CPP_UNITTEST_SCRIPT = 'flame/flame/execute_unittest.sh'
...
#YBUILD_FILE_PATH = 'libs/ybuild/'
#YBUILD_FILE_PREFIX = '//%s' % YBUILD_FILE_PATH
